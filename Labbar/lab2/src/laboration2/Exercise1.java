...
public class Exercise1 {
    ...
    // Metoden readPersons:
    // Metoden läser innehållet i filen personer.txt rad för rad.
    // Av varje rad i textfilen skapas ett Person-objekt vilket lagras i en ArrayList.
    // Referensen till ArrayList-objektet returneras och referensen lagras i variabeln list.
    ...
    public static void main( String[] args ) {
        ...
        Person person2 = new Person( "011003-4444", "Alma", "BjÃ¶rk" );
        Person p;
        int a;
