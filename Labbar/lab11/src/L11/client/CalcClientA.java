...
public class CalcClientA implements CalcClient {
    ...
    private void connect() throws IOException {
        ...
        //koppla upp mot servern, skriv ip adress o port, man gör detta med Socket
        Socket socket = new Socket("195.178.227.53", 722);
    ...
    public void newCalculation(String expression) throws IOException {
        ...
        // 2. Överför en sträng (expression) med writeUTF(). med output stream objekt
